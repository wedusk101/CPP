...
#define PADDING 8 // each row will take up 64 bytes - 8 elements each of 8 bytes [sizeof(long long)]
...
long double getPi(uint32_t numThreads, long long samples)
{
	...
	long long count[numThreads][PADDING] = {0}; // padding to avoid false sharing
