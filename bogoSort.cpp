/*The following code implements the exceedingly inefficient bogo sort algorithm to sort a list of integers in ascending order. It has a factorial class complexity.
There is a chance that this algorithm may never finish. This is not a bug.*/
#include <iostream>
#include <random>
#include <ctime>
#include <chrono>
